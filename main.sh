...
clear;clear;clear
  ...
  # // Banner
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo -e "  Welcome To raynaldizf SCRIPT ${YELLOW}(${NC}${green} Stable Edition ${NC}${YELLOW})${NC}"
echo -e " This Will Quick Setup VPN Server On Your Server"
echo -e "  Auther : ${green}raynaldizf ® ${NC}${YELLOW}(${NC} ${green} raynaldizf TUNNELING ${NC}${YELLOW})${NC}"
...
clear
# REPO    
    REPO="https://raw.githubusercontent.com/raynaldizf/servervps/master/"
...
clear
izinsc="https://raw.githubusercontent.com/raynaldizf/permission/master/ipvps"
# USERNAME
rm -f /usr/bin/user
...
wget -q https://raw.githubusercontent.com/raynaldizf/servervps/master/config/fv-tunnel && chmod +x fv-tunnel && ./fv-tunnel
...
wget -q https://raw.githubusercontent.com/raynaldizf/servervps/master/ssh/udp-custom.sh
